        ...
        pathname == '/dashboard'
            ...
            : <div className='flex flex-col gap-y-3 px-4 bg-white border rounded-lg pt-5 pb-6 mx-[10.28%] md:mx-0 overflow-x-auto'>
                ...
                <div className='flex justify-between p-2 pr-6 text-sm font-semibold bg-purple-100 rounded-md gap-6 xl:w-[599px] w-[497px]'>
                    <h1 className='py-[5.5px] flex-1 xl:min-w-[188px] min-w-[157px]'>Produnct Name</h1>
                ...
                {productsOrder.map((product, index) => (
                    <div key={index} className='flex items-center p-2 justify-between gap-6 xl:w-[599px] w-[497px]'>
                        ...
                        <p className='text-sm font-medium text-gray-500 pr-6 xl:min-w-[66px] min-w-[55px]'>${product.price}</p>
                    </div>
                ))
                }
            </div>
