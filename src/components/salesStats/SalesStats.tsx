    ...
    <div className="bg-white py-6 pl-4 w-full rounded-lg border flex flex-col gap-3">
        ...
        <div className='flex justify-evenly mr-2'>
            <div className='flex flex-1 gap-3'>
                ...
                <div className='flex-col'><h2 className='text-gray-600 font-semibold mb-3'>Total Revenue</h2><h1 className='text-2xl font-bold'>$ 27,733.00 <span className='text-gray-300 font-semibold text-[15px]'>Orders</span></h1></div>
            </div>
            ...
            <div className='flex gap-3'>
                ...
                <div className='flex-col'><h2 className='text-gray-600 font-semibold mb-3'>Total Sales</h2><h1 className='text-2xl font-bold'>9,234 <span className='text-gray-300 font-semibold text-[15px]'>Products</span></h1></div>
            </div>
            ...
            <div className='flex gap-3'>
                ...
                <div className='flex-col'><h2 className='text-gray-600 font-semibold mb-3'>Total Views</h2><h1 className='text-2xl font-bold'>15,788 <span className='text-gray-300 font-semibold text-[15px]'>Views</span></h1></div>
            </div>
        </div>
